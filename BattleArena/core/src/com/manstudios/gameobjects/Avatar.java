...
public class Avatar {
    ...
    public static final int ACTUAL_GAME_HEIGHT = 400;
        ...
        // CONSTRUCTORS
    /**
     * Primary Constructor - instantiates a new Avatar w/ default values
    ...
    // ============================ Avatar Movement ============================
        // moveDirectionOn() is called when the corresponding button is pressed down (including held)
                // continuously moves in that direction
        // moveDirectionOff() is called when the corresponding button is released
                // continuosly moves in the opposite direction, but since it's release
                // only is activated once (unlike keyDown = press or hold down)
    ...
    /**
     * Retrieves an Avatar's mass
     * @return the Avatar's mass
     */
